...
class BootstrapDetail extends Paginator
{
    ...
    protected  function gopage()
    {
        ...
        return $gotohtml="<li><form action='' method='get' ><a style='float:left;margin-left:2px;margin: 0;padding: 0;;'><input style='height:33px;width: 50px;margin: 0;padding: 0;' type='text' name='page' placeholder='请选择页数'> <input style='height:33px;' type='submit' value='确定'> </a></form></li>";
        // return $totalhtml;;
